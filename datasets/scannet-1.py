        ...
        for pose_path in pose_paths:
            ...
            for line in lines:
                try:
                    ...
                    print("ERROR in file:", f, "line:", repr(line))
                    raise
...
#         """
        ...
        try:
            ...
            print("Successfully imported process_mask_edges_for_pointcloud in get_mask_edges")
        except ImportError as e:
            print(f"Failed to import process_mask_edges_for_pointcloud in get_mask_edges: {e}")
            return set()
        ...
        try:
            ...
            print(f"Failed to save mask edges to {edge_file}: {e}")
